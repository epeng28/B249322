...
table
```
Figure 3. Table ranking total Salbutamol prescriptions by Scottish health board. Note with prescriptions per 100k population, many patients will likely have repeat prescriptions.
```{r}
...
Rates are high across areas like Dumfries and Galloway and NHS Lanakshire.
