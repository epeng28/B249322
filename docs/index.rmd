...
```{r, message = FALSE, out.height="30%", out.width="80%", fig.cap="Figure 4a. Maps visualising prescription rates across NHS Scotland health boards."}
...
```{r,  message = FALSE, out.height="30%", out.width="80%", fig.cap="Figure 4b. Average SIMD decile across NHS Scotland health boards (red = more deprived, blue = less deprived)."}
...
Continuous monitoring of Salbutamol prescriptions is necessary to track respiratory health in Scotland. Future reports can analyse how trends in age structure or smoking rates effect prescription rates. With climate change becoming an increasing concern worldwide, metered-dose inhalers are increasingly being replaced by other more environmentally-friendly  such options as dry powder inhalers. Future research can explore alternative forms of salbutamol or other bronchodilators being prescribed in efforts to preserve climate health. 
